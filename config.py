...
class Config:
    ...
    DPCRM_ACCESS_TOKEN=os.getenv("DPCRM_ACCESS_TOKEN")
    DPCRM_USER_TOKEN_TOKEN = os.getenv("DPCRM_USER_TOKEN_TOKEN")
    ...
    DPCRM_STATUS_ID_CHECK_REMINDER = int(os.getenv("DPCRM_STATUS_ID_CHECK_REMINDER"))
    REMIND_LEAD_FROM_VICTORY_DELAY = int(os.getenv("REMIND_LEAD_FROM_VICTORY_DELAY"))
    REMIND_LEAD_FROM_VICTORY_PERIOD = int(os.getenv("REMIND_LEAD_FROM_VICTORY_PERIOD"))
    REMIND_LEAD_FROM_VICTORY_PHRASE = os.getenv("REMIND_LEAD_FROM_VICTORY_PHRASE")
