...
class Config:
    ...
    DPCRM_VALID_CLIENT_STATUSES=os.getenv("DPCRM_VALID_CLIENT_STATUSES")
    DPCRM_LINK_RECEIVED=os.getenv("DPCRM_LINK_RECEIVED")
    DPCRM_ARCHIVE_STATUS=os.getenv("DPCRM_ARCHIVE_STATUS")
    DPCRM_PING_ALLOWED=os.getenv("DPCRM_PING_ALLOWED")
